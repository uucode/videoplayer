...
public class BZNativeVideoView extends BZBaseGLSurfaceView {
    ...
    public void setDataSource(final String videoPath) {
        if (!checkVideoPath(videoPath)) {
            Toast.makeText(getContext(), "videoPath is not available videoPath=" + videoPath, Toast.LENGTH_LONG).show();
            BZLogUtil.e(TAG, "videoPath is not available videoPath=" + videoPath);
            return;
        }
        ...
        VideoPlayer.setPlayLoop(videoPlayerHandle, playLoop);
